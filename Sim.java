...
class Sim {
	...
	public static void Initialization() {
		...
		Event evt = new Event(arrival,
				exponential(stream, MeanInterArrivalTime));
	...
	public static void ProcessArrival(Event evt) {
		...
		Event next_arrival = new Event(arrival, Clock
				+ exponential(stream, MeanInterArrivalTime));
	...
	public static void ReportGeneration() {
		...
		System.out
				.println("SINGLE SERVER QUEUE SIMULATION - GROCERY STORE CHECKOUT COUNTER ");
